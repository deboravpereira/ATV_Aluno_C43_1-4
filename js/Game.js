...
showLeaderboard() {
  ...
  //Crie as variáveis dos líderes

  //Obtenha dados dos players


  if (/* Condição para exibir ranking*/) {
  ...
  //Atribua leader1 como elemento html
  //Atribua leader2 como elemento html
}
